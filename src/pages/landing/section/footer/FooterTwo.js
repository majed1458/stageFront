        ...
        <Footer className={props.className && props.className} id={props.id && props.id}>
            <Container>
                ...
                <Row className="g-3 align-items-center justify-content-md-between py-4">
                    <Col md="8">
                        <div>
                            Copyright &copy; 2023 majed. Template Made by 
                            <a className="text-base fw-bold" href="https://www.linkedin.com/in/majed-ben-khalifa-18253b177/" target="_blank" rel="noreferrer"> Majed </a>
                        </div>
                    </Col>
