...
import LogoDrak2x from '../../images/mylogo.png'
import LogoLight2x from '../../images/Sans titre-2.png'
...
const BannerFive = (props) =>{
    ...
    return(
        <Header className={props.className && props.className} id={props.id && props.id} >
            <HeaderMain className={`header-main-s2 is-sticky is-transparent on-dark ${offset > 0 ? "has-fixed" : ""}`}>
                    ...
                    <HeaderWrap>
                        ...
                        <nav className={`header-menu menu ${toggle === true ? "active" : ""} ${mobileView ? "mobile-menu" : ""}`}> 
                            ...
                            <ul className="menu-btns">
                                <li>
                                    <Link to={`${process.env.PUBLIC_URL}/auth-login`} target="self" rel="noreferrer" className="btn-primary btn-lg">Sign In</Link>
                                </li>
                            </ul>
                        </nav>
                        ...
                        <Col lg="6">
                            <HeaderCaption>
                                <div className='header-rating rating'>
                                    ...
                                    <RatingText>4,252 reviews</RatingText>
                                </div>
                                <HeaderTitle className="fw-medium" style={{"color":"white !important"}}>Powerful AI Tool For Detecting Car Accidents</HeaderTitle>
                                ...
                                <ul className="header-action btns-inline">
                                    <li>
                                        <Link to={`${process.env.PUBLIC_URL}/auth-register`} rel="noreferrer" className="btn-primary btn-lg btn-round"><span>Try it For Free!</span></Link>
                                    </li>
                                </ul>
                            </HeaderCaption>
                        </Col>
